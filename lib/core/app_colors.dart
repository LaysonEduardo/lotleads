...
class AppColors {
  static final Color title = Color(0xff00A5BB);
  ...
  static final Color background = Color(0xFF018397);
  static final Color borderLogin = Color(0xFF24B883);
  static final Color buttonHelp = Color(0xFF71e2b9);
